...
namespace DonVo2020.Algorithms.NetCore31.Common
{
    /// <summary>
    /// The Queue (FIFO) Data Structure.
    /// </summary>
    public class QueueGeneric<T> : IEnumerable<T> where T : IComparable<T>
    {
        /// <summary>
        /// INSTANCE VARIABLE.
        /// </summary>
        ...
        /// CONSTRUCTOR
        /// </summary>
        public QueueGeneric() : this(_defaultCapacity) { }

        public QueueGeneric(int initialCapacity)
        {
        ...
        private void _resize(int newSize)
        {
            if (newSize > _size && !IsMaximumCapacityReached)
            {
                ...
                try
                {
                    ...
                    System.Array.Copy(_collection, _headPointer, tempCollection, 0, _size);
        ...
        public T Dequeue()
        {
            ...
            if (_size > 0 && _collection.Length > _defaultCapacity && _size <= _collection.Length / 4)
            {
                ...
                _headPointer = System.Array.IndexOf(_collection, head);
                _tailPointer = System.Array.IndexOf(_collection, tail);
            }
