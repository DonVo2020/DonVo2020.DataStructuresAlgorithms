...
namespace DonVo2020.Algorithms.NetCore31.BipartiteColoring
{
        ...
        where TVertex : IComparable<TVertex>
    {
        ...
        public BipartiteColoring(IGraph<TVertex> Graph)
        {
            ...
            if (Graph.VerticesCount < 2)
                throw new Exception("Graph contains less elements than required.");
            ...
            foreach (var vertex in Graph.Vertices)
            {
                ...
                if (!_visited[vertexIndex])
                {
                    ...
                    if (!_isBipartite)
                        throw new Exception("Graph contains an odd cycle.");
                }
            }
        }
        ...
        public BipartiteColor ColorOf(TVertex vertex)
        {
            if (!_isBipartite)
                ...
                throw new Exception("Vertex doesn't belong to graph.");
