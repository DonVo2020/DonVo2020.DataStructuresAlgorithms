...
namespace DonVo2020.DataStrutures.NetCore31.Trees.RedBlackTree
{
    public class RedBlackTree
    {
        ...
        /// </summary>
        public class RedBlackTreeAlgorithm<TKey> : BinarySearchTree<TKey> where TKey : IComparable<TKey>
        {
            /// <summary>
            ...
            /// </summary>
            public RedBlackTreeAlgorithm() : base() { }

            /// <summary>
            /// CONSTRUCTOR.
            /// If allowDuplictes is set to false, no duplicate items will be inserted.
            /// </summary>
            public RedBlackTreeAlgorithm(bool allowDuplicates) : base(allowDuplicates) { }
